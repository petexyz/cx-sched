...
// The gag column: what each race pairs with. Keyed by the event's name (`n`). Not advice; drink responsibly (21+ in the US).
CX.pairings = {
  "Rochester Cyclocross (USCX)": { beer: "Genesee Cream Ale", bourbon: "Old Forester 86", why: "Hometown cream ale for the sand pit, bourbon for the podium." },
  "Virginia's Blue Ridge Go Cross (USCX)": { beer: "Starr Hill Northern Lights IPA", bourbon: "Bulleit Bourbon", why: "Blue Ridge climbs deserve a hoppy reward." },
  "Charm City Cross (USCX)": { beer: "National Bohemian (Natty Boh)", bourbon: "Old Grand-Dad Bonded", why: "Baltimore rules: Natty Boh first, bourbon for the mud." },
  "Kings CX": { beer: "Rhinegeist Truth IPA", bourbon: "Woodford Reserve", why: "Ohio beer, Kentucky bourbon, a short drive apart." },
  "Major Taylor Cross Cup": { beer: "Sun King Sunlight Cream Ale", bourbon: "Michter's US*1 Bourbon", why: "An Indianapolis cream ale for a race named after a legend." },
  "Cycle-Smart Northampton": { beer: "Tree House Julius IPA", bourbon: "Basil Hayden", why: "Western Mass hazy IPA, smooth bourbon." },
  "Pan-American Championships / DCCX": { beer: "DC Brau The Public Pale Ale", bourbon: "Four Roses Small Batch", why: "Diplomatic pours for a continental championship." },
  "Boulder Cup": { beer: "Avery White Rascal", bourbon: "Breckenridge Bourbon", why: "Colorado altitude: both drinks hit harder up here." },
  "North Carolina Grand Prix": { beer: "Sierra Nevada Torpedo IPA", bourbon: "Elijah Craig Small Batch", why: "Sierra Nevada has a brewery down the road, so no excuses." },
  "USA Cycling National Championships": { beer: "Yuengling Lager", bourbon: "Wild Turkey 101", why: "Stars, stripes and a lager. Go big for Nationals." },
  "Canadian Championships": { beer: "Steam Whistle Pilsner", bourbon: "Maker's Mark", why: "Canada gets bourbon too. Sorry, rye." },
  "HG Cross Dendermonde": { beer: "Gouden Carolus Tripel", bourbon: "Knob Creek 9", why: "A Tripel matches the pace of a Dendermonde flyer." },
  "Berencross": { beer: "Leffe Brune", bourbon: "Heaven Hill Bottled-in-Bond", why: "Beren means bears: something brown and burly." },
  "HG Cross Heerderstrand": { beer: "Hertog Jan Tripel", bourbon: "Evan Williams Black", why: "Sand and a beach in the Netherlands: sunscreen optional." },
  "Rapencross": { beer: "Saison Dupont", bourbon: "Old Ezra 7", why: "'Rapen' is Dutch for turnips, so an earthy farmhouse saison." },
  "Zilvermeercross": { beer: "Westmalle Tripel", bourbon: "Four Roses Single Barrel", why: "White sand, silver lake, golden Tripel." },
  "Parkcross": { beer: "Maes Pils", bourbon: "Jim Beam White", why: "A park race is unpretentious, like a Maes." },
  "Waaslandcross": { beer: "St. Bernardus Abt 12", bourbon: "Blanton's", why: "Sint-Niklaas means Saint Nicholas, so a saintly Abt." },
  "Vlaamse Druivencross": { beer: "Boon Kriek", bourbon: "Angel's Envy", why: "Grape race, cherry beer. Close enough." },
  "Middelkerke (evening, Halloween theme)": { beer: "Chimay Blue", bourbon: "Booker's", why: "Halloween night race: a dark ale and a scary-strong bourbon." },
  "Jaarmarktcross": { beer: "Palm", bourbon: "Very Old Barton", why: "A fair-day cross calls for a cheerful amber." },
  "Aardbeiencross": { beer: "Lindemans Fraise", bourbon: "Maker's 46", why: "Strawberry cross, strawberry lambic." },
  "Ruddervoorde": { beer: "Gouden Carolus Christmas", bourbon: "Woodford Reserve Double Oaked", why: "The Sinterklaas cross: treat yourself to a winter warmer." },
  "Christmas cross": { beer: "Delirium Christmas", bourbon: "Eagle Rare 10", why: "Racing on Christmas Day: eggnog optional, bourbon not." },
  "Diegem": { beer: "Duvel", bourbon: "Weller Special Reserve", why: "Floodlit race, so a beer that glows like it." },
  "Gullegem": { beer: "Hoegaarden Wit", bourbon: "Henry McKenna 10", why: "The race is Jan 2, so a gentle wit. The bourbon is medicinal." },
  "Koppenbergcross": { beer: "Liefmans Goudenband", bourbon: "Elijah Craig Barrel Proof", why: "A steep cobbled climb needs Oudenaarde's own Goudenband." },
  "Bollekescross": { beer: "De Koninck", bourbon: "Rowan's Creek", why: "Pun alert: De Koninck's glass is called a bolleke." },
  "Be-Mine Cross": { beer: "Gulden Draak Imperial Stout", bourbon: "Wild Turkey Rare Breed", why: "Old coal-mine venue, so something black and heavy." },
  "Plage Cross": { beer: "Leffe Blonde", bourbon: "Jim Beam Black", why: "A beach cross: a blond ale, sunglasses optional." },
  "Azencross": { beer: "Westmalle Dubbel", bourbon: "Knob Creek 12", why: "A Christmas-week classic: a Trappist double is on-brand." },
  "GP Sven Nys": { beer: "Kwak", bourbon: "Russell's Reserve 10", why: "The Cannibal of Baal: a hearty Kwak in its yard glass." },
  "Krawatencross": { beer: "Tripel Karmeliet", bourbon: "Jefferson's Reserve", why: "Necktie race: a fancy Tripel, pinkie out." },
  "Brussels Universities Cross": { beer: "Delirium Tremens", bourbon: "Larceny", why: "Student race: pink elephants on tap." },
  "World Cup #1": { beer: "Radegast", bourbon: "Baker's", why: "A night race in Ostrava: a Radegast, then bourbon for the cold." },
  "World Cup #2": { beer: "Pilsner Urquell", bourbon: "Old Forester 1920", why: "Czech double-header: Pilsner Urquell, naturally." },
  "World Cup #3": { beer: "Tennent's Lager", bourbon: "Barrell Craft Bourbon", why: "Glasgow: Tennent's, plus bourbon to keep the Scotch honest." },
  "World Cup #4": { beer: "Vedett Extra Blond", bourbon: "Buffalo Trace", why: "Antwerp: a fashionable blond and a reliable bourbon." },
  "World Cup #5": { beer: "Westvleteren 12", bourbon: "Wild Turkey Longbranch", why: "Dunes and sand: a Westvleteren 12, as hard to find as a good line." },
  "World Cup #6": { beer: "Maredsous 8", bourbon: "Jim Beam Devil's Cut", why: "Boxing Day: a Maredsous, and Devil's Cut for the leftovers." },
  "World Cup #7": { beer: "Rochefort 10", bourbon: "Old Fitzgerald Bottled-in-Bond", why: "Rochefort is in Namur province, so keep it local." },
  "World Cup #8": { beer: "Jenlain Ambrée", bourbon: "Four Roses Small Batch Select", why: "Franche-Comté: a bière de garde, and a cheese board." },
  "World Cup #9": { beer: "Chimay Red", bourbon: "Knob Creek Smoked Maple", why: "Round 9 of 12: you need stamina, and something reliably red." },
  "World Cup #10": { beer: "Estrella Damm", bourbon: "Old Grand-Dad 114", why: "Beach resort in January: a cold Estrella, bourbon over ice." },
  "World Cup #11": { beer: "Straffe Hendrik Quadrupel", bourbon: "Michter's Toasted Barrel Finish", why: "Second-to-last round: a Quad for the build-up." },
  "World Cup #12 (finale)": { beer: "La Trappe Quadrupel", bourbon: "Pappy Van Winkle 15 (if you have it)", why: "Season finale: a Trappist quad and the good bottle." },
  "European Championships": { beer: "Grolsch Pilsner", bourbon: "Wild Turkey 81", why: "Zeddam hosted the 2006 Worlds, so a Grolsch in tribute." },
  "World Championships": { beer: "Piraat", bourbon: "Elmer T. Lee", why: "Ostend Worlds: a Piraat for the seaside, bourbon for the rainbow jersey." },
  "Belgian Championships (BK)": { beer: "Jupiler", bourbon: "Old Charter 8", why: "The most Belgian pour there is." },
  "Dutch Championships (NK)": { beer: "Amstel", bourbon: "Weller Antique 107", why: "Dutch nationals: keep it simple with an Amstel." }
};
